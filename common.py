...
def set_gpt3_env():
    openai.api_key = st.secrets["GPT3_OPENAI_API_KEY"]
    openai.api_base = st.secrets["GPT3_OPENAI_API_BASE"]
    openai.api_version = st.secrets["GPT3_OPENAI_API_VERSION"]
    openai.api_type = st.secrets["GPT3_OPENAI_API_TYPE"]
    st.session_state["openai_model"] = "gpt-35-turbo"

def set_gpt4_env():
    openai.api_key = st.secrets["GPT4_OPENAI_API_KEY"]
    openai.api_base = st.secrets["GPT4_OPENAI_API_BASE"]
    openai.api_version = st.secrets["GPT4_OPENAI_API_VERSION"]
    openai.api_type = st.secrets["GPT4_OPENAI_API_TYPE"]
